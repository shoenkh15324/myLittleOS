...
#define APP_BOARD BOARD_NONE
    ...
    #endif
    #define APP_DRIVER_GFX DRIVER_GFX_BGFX
    #define APP_DRIVER_PHYSICS_BACKEND DRIVER_PHYSICS_BACKEND_JOLT
    #if APP_DRIVER_PHYSICS_BACKEND == DRIVER_PHYSICS_BACKEND_JOLT
        #define DRIVER_PHYSICS_BACKEND_JOLT_TEMP_ALLOCATOR_SIZE (10 * 1024 * 1024)
        #define DRIVER_PHYSICS_BACKEND_JOLT_MAX_BODIES 1024
        #define DRIVER_PHYSICS_BACKEND_JOLT_NUM_BODY_MUTEXES 0 // default: 0
        #define DRIVER_PHYSICS_BACKEND_JOLT_NUM_BODY_PAIRS 1024
        #define DRIVER_PHYSICS_BACKEND_JOLT_MAX_CONTACT_CONSTRAINTS 1024
        #define DRIVER_PHYSICS_BACKEND_JOLT_DELTA_TIME (1.0f / 60.0f)
        #define DRIVER_PHYSICS_BACKEND_JOLT_COLLISTION_STEP 1
    #endif
#elif APP_BOARD
    #define APP_DRIVER_XXX 0
#endif
